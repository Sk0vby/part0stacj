...
sequenceDiagram
    ...
    browser->>server: GET https://studies.cs.helsinki.fi/exampleapp/notes (note data)
    activate server
    ...
    %% (Opcjonalnie: pobranie strony i zasobów — jeśli chcesz, mogę przywrócić te żądania na początek)
